...
root=Tk()
root.title('Music PLayer from José de Brito ')
mixer.init()

songs_list=Listbox(root,selectmode=SINGLE,bg="black",fg="white",font=('arial',16),height=12,width=48,selectbackground="gray",selectforeground="black")
